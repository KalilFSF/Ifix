...
# liga o SQLAlchemy/Flask-Login e registra as rotas de autenticação.
# É este arquivo que você roda: `python app.py`.
...
def create_app():
    ...
    # Cria as tabelas no SQLite se ainda não existirem (não é uma migration,
    # só funciona pra criar do zero; se mudar um model depois, apague o ifix.db
    # e deixe o app recriar, ou adicione Flask-Migrate/Alembic no futuro).
